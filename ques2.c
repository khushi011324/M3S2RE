...
int main(int argc, char** argv) {
    int rank, size;
    unsigned long rowsA = 1000; // Number of rows in matrix A
    unsigned long colsA = 1000; // Number of columns in matrix A
    unsigned long colsB = 1000; // Number of columns in matrix B
    int* A, * B, * C;
    int* localA, * localC;
    ...
    unsigned long rowsPerProcess = rowsA / size;
    unsigned long remainingRows = rowsA % size;
